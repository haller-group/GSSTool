%% Von Karman shell — chaotic forcing: aSSM anchor vs. full-order
...
% excitation, and compares it against a full-order (Newmark) time
% integration.
%
% For the forcing-weakness ratio r_w, see the companion script
% rw_calculation_chaotic.m. For a Galerkin-ROM comparison on top of this
% same setup, see Plate_chaotic_GSS_Galerkin.m.
...
%% Plot: response torus in 3D, 150 slowest modes (full-order vs. O(1) vs. O(6) aSSM anchor)
figure
...
legend('Full model','$O(1)$ GSS','$O(6)$ GSS','Interpreter','latex')
view(144,13)
